...
//----------------------------------------COMPONENTS--------------------------------------------//
		...
		/********LIST OF VOTES********/
			listVOTE = new List();
				...
				//SET BOUNDS 
					listVOTE.setBounds(170, 340, 300, 255);
				//ADD TO PANE
		...
		/********BUTTONS********/
			...
			JButton btnDEL = new JButton("DELETE ACCOUNT");
				...
				//SET BOUNDS
				btnBACK.setBounds(20,625,120,35);
				btnDEL.setBounds(400,625,200,35);
				//ADD TO PANE
				accountPANE.add(btnBACK);
				accountPANE.add(btnDEL);
//------------------------------------------FRAME----------------------------------------------//
		JFrame accountFRAME = new JFrame("JSCR 2022 ELECTION | Delete Account");
			accountFRAME.setVisible(true);
			accountFRAME.setResizable(false);
			accountFRAME.setBounds(410, 7, 640, 720);
...
//------------------------------------------EVENTS----------------------------------------------//
			...
			try {
				...
				String SQL ="SELECT * FROM tbl_userinfo WHERE bp_USERNAME = '" +AdminFrame.delUSERNAME+"'";
				//String votes;
			...
			try {
				...
				java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
				java.sql.Statement stmt=con.createStatement();
				String SQL ="SELECT * FROM tbl_votes WHERE bp_USERNAME ='" +AdminFrame.delUSERNAME+"'";
				ResultSet rs = stmt.executeQuery(SQL);	
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(yes==JOptionPane.YES_OPTION) {
						 if(LoginFrame.usrNAME.equals("ADMIN") || LoginFrame.usrNAME.equals("admin")) {
							if(listVOTE.getItem(3).equals("                       NO VOTES YET")) {
								try {
									Class.forName("com.mysql.cj.jdbc.Driver");
									java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
						...
						}else if(LoginFrame.usrNAME.equals("CHRM") || LoginFrame.usrNAME.equals("chrm")) {
							if(listVOTE.getItem(3).equals("                       NO VOTES YET")) {
								try {
									Class.forName("com.mysql.cj.jdbc.Driver");
									java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(3).toString().substring(4) +"%'";
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(4).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(5).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(6).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(7).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(8).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(9).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(10).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(11).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="UPDATE tbl_tally SET bp_TOTAL = (bp_TOTAL - 1) WHERE bp_CANDIDATES LIKE '%" + listVOTE.getItem(12).toString().substring(4) +"%'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="DELETE FROM  tbl_userinfo WHERE  bp_USERNAME = '" + AdminFrame.delUSERNAME + "'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
						...
						try {
							Class.forName("com.mysql.cj.jdbc.Driver");
							java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_oopr213","root","");
							String v1 ="DELETE FROM  tbl_votes WHERE  bp_USERNAME = '" + AdminFrame.delUSERNAME + "'";
	    		    		java.sql.PreparedStatement prpstm1 = ((Connection) con).prepareStatement(v1);			
	    		   	        	prpstm1.executeUpdate();	
	    		   	        	((Connection) con).close();
						}catch(Exception ex) {
