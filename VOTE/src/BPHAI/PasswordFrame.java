...
//----------------------------------------EVENTS----------------------------------------------//
			btnLOGIN.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if(txfPASS.getText().equals("JSCR2022")){
						JOptionPane.showMessageDialog(null,"Password should be different" + "\n" + "from the default password");
						txfPASS.setText("");
						txfPASScon.setText("");
						txfPASS.requestFocus();
					}
					else if (txfPASS.getText().length() >= 8 && txfPASS.getText().equals(txfPASScon.getText())) {
						try 
		        		{
